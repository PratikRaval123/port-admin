...
import { updateProject, getProjects, reset } from "@/store/features/projectSlice";
...
const EditProjectPage = () => {
    ...
    const { id } = useParams();
    const { projects, isLoading, isError, isSuccess, message } = useAppSelector(
        (state) => state.project
    );
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (id) {
            const resultAction = await dispatch(updateProject({ id: id as string, projectData: data }));
